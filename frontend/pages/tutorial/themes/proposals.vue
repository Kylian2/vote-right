			...
			<div class="theme__interactions__sidebar theme__background">
				...
				<nav>
					<ul class="theme__interactions__sidebar__summary">
						<li><a href="#part1" class="theme__interactions__sidebar__summary__shortens"> 1. Créer une nouvelle proposition </a></li>
						<li><a href="#part2" class="theme__interactions__sidebar__summary__shortens"> 2. Discuter sur une proposition </a></li>
						<li><a href="#part3" class="theme__interactions__sidebar__summary__shortens"> 3. Demander le vote d’une proposition </a></li>
						<li><a href="#part4" class="theme__interactions__sidebar__summary__shortens"> 4. Signaler un message inapproprié </a></li>
					</ul>
				</nav>
			</div>
		</div>
