			...
			<div class="theme__interactions__sidebar theme__background">
				...
				<nav>
					<ul class="theme__interactions__sidebar__summary">
						<li><a href="#part1" class="theme__interactions__sidebar__summary__shortens"> 1. Administrateur </a></li>
						<li><a href="#part2" class="theme__interactions__sidebar__summary__shortens"> 2. Décideur </a></li>
						<li><a href="#part3" class="theme__interactions__sidebar__summary__shortens"> 3. Modérateur </a></li>
						<li><a href="#part4" class="theme__interactions__sidebar__summary__shortens"> 4. Assesseur </a></li>
						<li><a href="#part5" class="theme__interactions__sidebar__summary__shortens"> 4. Membre </a></li>
					</ul>
				</nav>
			</div>
		</div>
