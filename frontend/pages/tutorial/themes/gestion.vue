                    ...
                    <ul class="theme__interactions__sidebar__summary">
                        <li>
                            <a href="#part1" class="theme__interactions__sidebar__summary__shortens">
                                1. Modifier les budgets d’un groupe
                            </a>
                        </li>
                        <li>
                            <a href="#part2" class="theme__interactions__sidebar__summary__shortens">
                                2. Ajouter un thème à un groupe
                            </a>
                        </li>
                        <li>
                            <a href="#part3" class="theme__interactions__sidebar__summary__shortens">
                                3. Modifier les informations d’un groupe
                            </a>
                        </li>
                        <li>
                            <a href="#part4" class="theme__interactions__sidebar__summary__shortens">
                                4. Modifier ou supprimer une proposition
                            </a>
                        </li>
                        <li>
                            <a href="#part5" class="theme__interactions__sidebar__summary__shortens">
                                5. Planifier le vote d’une proposition
                            </a>
                        </li>
                        <li>
                            <a href="#part6" class="theme__interactions__sidebar__summary__shortens">
                                6. Gérer les rôles au sein d’un groupe
                            </a>
                        </li>
                        <li>
                            <a href="#part7" class="theme__interactions__sidebar__summary__shortens">
                                7. Valider les votes d’une proposition
                            </a>
                        </li>
                        <li>
                            <a href="#part8" class="theme__interactions__sidebar__summary__shortens">
