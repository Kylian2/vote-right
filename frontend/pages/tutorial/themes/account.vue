			...
			<div class="theme__interactions__sidebar theme__background">
				...
				<nav>
					<ul class="theme__interactions__sidebar__summary">
						<li><a href="#part1" class="theme__interactions__sidebar__summary__shortens"> 1. Gérer les paramètres de notification </a></li>
						<li><a href="#part2" class="theme__interactions__sidebar__summary__shortens"> 2. Modifier les informations de son compte </a></li>
						<li><a href="#part3" class="theme__interactions__sidebar__summary__shortens"> 3. Modifier son mot de passe </a></li>
						<li><a href="#part4" class="theme__interactions__sidebar__summary__shortens"> 4. Supprimer son compte </a></li>
					</ul>
				</nav>
			</div>
		</div>
