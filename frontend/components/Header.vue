<template>
    <header class="header--desktop" :class="{ [`color-${color}`]: color }">
        ...
        <div v-if="type === 'logged'" class="logged" :class="{ active: actif === 'account' }">
            <NuxtLink to="my-settings" class="logged__link shine">Mon compte</NuxtLink>
        </div>
    </header>
    ...
    <header class="header--mobile" id="header-mobile" :class="{ [`color-${color}`]: color }">
        ...
        <nav v-if="type === 'logged'" class="logged d-none" id="navigation-mobile">
            ...
            <NuxtLink to="/my-settings">Mon compte</NuxtLink>
        </nav>
    </header>
</template>
