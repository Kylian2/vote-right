...
BEGIN
    ...
    SELECT VOT_proposal_NB, VOT_round_NB, VOT_valid_BOOL, VOT_start_DATE, VOT_end_DATE, SYS_label_VC, VOT_type_NB, SYS_nb_rounds_NB
    FROM vote
    ...
    fetchinformations: LOOP
        FETCH informations INTO proposal_NB, round_NB, valid_BOOL, start_DATE, end_DATE, type_VC, type_NB, nb_rounds_NB;
