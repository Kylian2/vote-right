...
CREATE TABLE proposal (
    ...
    PRO_creation_DATE DATE NOT NULL,
    ...
    PRO_status_VC VARCHAR(20) DEFAULT 'En attente' NOT NULL,
    PRO_initiator_NB INT NOT NULL,
    PRO_deleter_NB INT,
    PRO_budget_year_DATE DATE,
    PRO_approver_NB INT,
...
CREATE TABLE vote_detail (
    ...
    DET_user_NB INT, 
    DET_voted_on_DATE DATE NOT NULL, 
