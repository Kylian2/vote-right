...
SELECT RES_label_VC, COM_id_NB, COM_message_VC, RPT_user_NB, USR_firstname_VC, USR_lastname_VC, RPT_creation_DATE , COM_proposal_NB, PRO_community_NB, RPT_status_VC
FROM report r
