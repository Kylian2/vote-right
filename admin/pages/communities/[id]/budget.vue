    ...
    <main class="budget">
            ...
            <div class="budget__header__cards">
                <div class="budget__card">
                    ...
                    <div class="budget__card__amount">
                        <p class="budget__card__amount__main"> {{ formatNumber(budget['CMY_budget_NB'] || 0) }} <span> €</span></p>
                        <p class="budget__card__amount__sub">dont <span> {{ formatNumber(budget['CMY_fixed_fees_NB'] || 0) }} </span> € de frais fixes</p>
                    </div>
                    <div class="budget__card__percentage">
                        <p><span> {{ Math.round(100 - ((budget['CMY_used_budget_NB'] || 0) / (budget['CMY_budget_NB'] || 0))*100) }}%</span> restant</p>
                    </div>
                </div>
                ...
                <div class="budget__card">
                    ...
                    <div class="budget__card__amount">
                        <p class="budget__card__amount__main"> {{ formatNumber(budget['CMY_used_budget_NB'] || 0) }} <span> €</span></p>
                    </div>
                </div>
                ...
                <div class="budget__card">
                    ...
                    <div class="budget__card__amount">
                        <p class="budget__card__amount__main"> {{ formatNumber(nonSpecifiedBudget) }} <span> €</span></p>
                    </div>
                    <div class="budget__card__percentage">
        ...
        <div class="budget__edits" :class="{'d-none' : !editBudgetBlock}">
                ...
                <div class="edit-budget">
                    <div>
                        ...
                        <div>
                            ...
                            :rules="[
                                (v) => (v >= budget['CMY_fixed_fees_NB'] + budgetTotalTheme || v === '') || 'Budget trop bas'
                            ]"
                            ></InputNumber>
                            <p> €</p>
                        </div>
            ...
            <div class="budget__edits__buttons">
                ...
                <button class="btn" formmethod="dialog" :disabled="!budgetValid" @click="updateBudget">Valider les modifications</button>
            </div>
        </div>
        ...
        <div class="budget__chart budget__chart--pie" id="theme-chart-pie" :class="{'d-none' : adoptedProposals.length === 0}">
        ...
        <div class="budget__chart budget__chart--pie" id="proposals-chart-pie" :class="{'d-none' : adoptedProposals.length === 0}">
...
const fetchData = async () => {
    try{
        ...
        nonSpecifiedBudget.value = budget.value['CMY_budget_NB'] - budget.value['CMY_budget_theme_NB']?.reduce((acc, val) => acc + val['BUT_amount_NB'], 0) - budget.value['CMY_fixed_fees_NB'];
...
const initCharts = () => {
    ...
    themesChart = new Chart(
        themeChartCanva.value.getContext('2d'),
        {
            type: 'bar',
            data: {
                labels: themeLabels,
    ...
    themeChartPie = new Chart(
        themeChartPieCanva.value.getContext('2d'),
        {
            type: 'pie',
            data: {
                labels: themeLabels,
    ...
    proposalsChartPie = new Chart(
        proposalsChartPieCanva.value.getContext('2d'),
        {
            type: 'pie',
            data: {
...
watch(editBudgetBlock, (n, o) => {
    if(n){
        ...
        budgetEditChart = new Chart(
            budgetEditChartCanva.value.getContext('2d'),
            {
                type: 'bar',
                data: {
